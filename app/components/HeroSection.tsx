			...
			<div className="relative z-10 max-w-4xl w-full mx-4">
				...
				>
					...
					<div className="font-mono">
						...
						<h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4">Ivan Zaporozhets</h1>
						...
						<div className="flex flex-wrap gap-2 mt-2">
							...
							<span className="px-3 py-1 bg-green-500/10 rounded-md border border-green-500/20">Kotlin</span>
